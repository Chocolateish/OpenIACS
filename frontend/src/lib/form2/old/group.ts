...
// import { unfold_less, unfold_more } from "@libOldIcons";
// import {
//   Component,
//   ValueComponent,
//   Way,
...
//   #valueComponents: { [s: string]: ValueComponent } = {};
//   protected __container: HTMLElement = this;
...
//       let id = comp.id;
//       if (id) {
//         if (id in this.#valueComponents)
//           console.warn("Component id already in group");
//         else this.#valueComponents[id] = comp;
//       }
//     }
...
//   get values() {
//     let vals: { [s: string]: ComponentValue } = {};
//     for (const key in this.#valueComponents) {
//       vals[key] = this.#valueComponents[key].value!;
//     }
//     return vals;
//   }
...
//     let vals: { [s: string]: ComponentValue } = {};
//     for (const key in this.#valueComponents) {
//       let val = this.#valueComponents[key].changed;
...
//     for (const key in this.#valueComponents)
//       if (typeof this.#valueComponents[key].changed !== "undefined")
//         return true;
//     return false;
//   }
