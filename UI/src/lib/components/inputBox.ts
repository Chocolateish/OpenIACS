...
import { defineElementValues, stringByteLength } from "@libCommon";
import { edit_calendar, schedule } from "@libIcons";
...
export class InputBox extends ValueComponent<InputBoxOptions> {
  ...
  set unit(_unit: string | Value | undefined) {}
...
defineElementValues(InputBox, ["unit"]);
