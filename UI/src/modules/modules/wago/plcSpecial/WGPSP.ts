...
export class WGPSP extends Module {
...
class Editor extends ModuleSettings {
  ...
  constructor() {
    ...
    this.group.addComponent(
      (this.physical = new DropDown().options({
        id: "physical",
    ...
    this.group.addComponent(
      (this.baudrate = new InputBox().options({
        id: "baudrate",
    ...
    this.group.addComponent(
      (this.dataBits = new InputBox().options({
        id: "dataBits",
    ...
    this.group.addComponent(
      (this.parity = new DropDown().options({
        id: "parity",
    ...
    this.group.addComponent(
      (this.stopBit = new DropDown().options({
        id: "stopBit",
    ...
    this.group.addComponent(
      (this.handshake = new DropDown().options({
        id: "handshake",
